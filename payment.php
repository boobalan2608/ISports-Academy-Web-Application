    ...
    <div class="payment">
        ...
        <div class="upimethod">
            ...
            <div class="paymethod1" onclick="toggle('paytm')">
                ...
                <h4 class="paytmid" id="paytmid">UPI ID: 1234567890@paytm<i class="fa-solid fa-copy"
            ...
            <div class="paymethod2" onclick="toggle('gpay')">
                ...
                <h4 class="gpayid" id="gpayid">UPI ID: 1234567890@okaxis<i class="fa-solid fa-copy"
            ...
            <div class="paymethod3" onclick="toggle('phonepe')">
                ...
                <h4 class="phonepeid" id="phonepeid">UPI ID: 1234567890@ybl<i class="fa-solid fa-copy"
                        onclick="copy('phonepe')" style="cursor: pointer;"></i></h4>
            </div>
        </div>
        <div class="bankmethod">
            <label class="bmdetails">Holder Name:</label><br>
            <h3 class="bankholder">John D<i class="fa-solid fa-copy" onclick="copybank('holder')"
                    style="cursor: pointer;"></i></h3>
            <label class="bmdetails">Bank/AC No:</label><br>
            <h3 class="bankno">911234567890<i class="fa-solid fa-copy" onclick="copybank('no')"
                    style="cursor: pointer;"></i></h3>
        ...
        <form action="payment.php" method="post" name="payment" enctype="multipart/form-data" onsubmit="return validateform()">
            <div class="paymentverify">
                <h1 class="paymentcard">Verify Your Payment</h1>
                <div class="photocard">
                    <h2 class="pvhead">Drop Your Payment Screenshot</h2>
                    <input type="file" id="paymentproof" style="position: absolute;top: -9999px;left: -9999px;" name="paymentss" required>
